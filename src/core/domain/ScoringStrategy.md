...
const files = [/* file combination to try */]
...
const candidates = disksWithSpace.map(disk =>
  scoreCombination(files, disk.freeBytes, disk.path)
)
...
const combinations = [/* many file combinations */]
