...
```typescript
import { transferFailed, backendUnavailable, diskFull } from "./errors";

const error1 = transferFailed("/mnt/disk1/file.mkv", "/mnt/disk2/file.mkv", "Connection refused");
...
const program = runPlan(options).pipe(withErrorHandling, Effect.provide(AppLive));
