...
) => Effect<void, never, LoggerService | FileSystem>
```
...
export const runShow = (
  options: { planFile: string | undefined }
...
```typescript
export const createAppLayer = () => Layer<
  DiskService | ScannerService | TransferService |
  LoggerService | PlanGeneratorService
>
